...
class SGe extends S {
  ...
  @override
  String get driverOfflineTitle => 'შედით ონლაინ რეჟიმში, რათა დაიწყოთ მოთხოვნების მიღება';

  @override
  String get payInCash => 'ნაღდი ანგარიშსწორება';

  @override
  String get payInCashDescription => 'გთხოვთ გააგრძელოთ მძღოლისთვის ნაღდი ანგარიშსწორება. მძღოლი დაადასტურებს გადახდას მიღებისთანავე.';

  @override
  String get addToFavoriteDrivers => 'დაამატეთ საყვარელ დრაივერებს';

  @override
  String get slideToConfirmArrival => 'გადაიტანეთ ჩასვლის დასადასტურებლად';

  @override
  String get slideToConfirmPickup => 'გადაიტანეთ აყვანის დასადასტურებლად';

  @override
  String get slideToConfirmDropoff => 'გადაიტანეთ ჩამოშვების დასადასტურებლად';

  @override
  String get noticePickingUpRiderIn => 'მხედრის აყვანა:';

  @override
  String get noticeRiderNotified => 'მხედარი ეცნობა, აიღე მხედარი და დაიწყე მგზავრობა';

  @override
  String get adminPanelOnboardingOneTitle => 'კეთილი იყოს თქვენი მობრძანება უკეთეს კომპლექტში';

  @override
  String get adminPanelOnboardingOneSubtitle => 'გაათავისუფლე შენი Q-Commerce-ის ძალა';

  @override
  String get adminPanelOnboardingTwoTitle => 'გაამარტივეთ თქვენი ოპერაციები';

  @override
  String get adminPanelOnboardingTwoSubtitle => 'მიიღეთ კონტროლი ჩვენი ცენტრალიზებული სუპერ პანელით';

  @override
  String get rider => 'მხედარი';

  @override
  String get customer => 'დამკვეთი';
